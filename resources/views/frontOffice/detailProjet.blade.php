            ...
            <div class="container">				
                <div class="row d-flex align-items-center justify-content-center">
                    <div class="about-content col-lg-12">
                        ...
                        <p class="text-white link-nav"><a href="{{url('frontOffice')}}">Accueil </a>  <span class="fas fa-angle-right"></span>  <a href="courses.html"> Projets <span class="fas fa-angle-right"></span>  <a href="courses.html"> Détail projet</a></p>
                    </div>	
                </div>
            </div>
        </section>
